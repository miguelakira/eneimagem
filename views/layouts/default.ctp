...
<body>
	...
	<div id="navigation">
		<ul>
			...
			<li><?php echo $html->link('Revista Domínios da Imagem', 'http://www2.uel.br/cch/his/dominiosdaimagem/index.htm'); ?></li>
			...
			<ul>
    			...
    			<li><a href="/eventos/eneimagem/2011/index.php/gallery/">Fotos do Evento <img src="/eventos/eneimagem/2011/webroot/img/novo.gif"></a> </li>
