...
<hr>
<ul class="disc">
    <p> <?php echo $html->image("../img/logo-uel.gif", array( "alt" => "Universidade Estadual de Londrina")); ?> </p>
...
<hr >
<?php echo $html->image("../img/capes.jpg", array( "alt" => "Capes")); ?> 
<li><p> Coordenação de Aperfeiçoamento de Pessoal de Nível Superior - CAPES</p></li>
<?php echo $html->image("../img/araucaria.jpg", array( "alt" => "Fundação Araucária")); ?>
